...
namespace Jewllery
{
    public partial class bracelet : System.Web.UI.Page
    {
        ...
        private void LoadBracelets()
        {
            ...
            {
                string query = "SELECT BraceletId, Name, Material, Price, ImageUrl FROM Bracelets";
                using (SqlCommand cmd = new SqlCommand(query, conn))
                {
                    ...
                    da.Fill(dt);
                    rptBracelets.DataSource = dt;
                    rptBracelets.DataBind();
                }
            }
        }
        ...
        protected void btnAddToCart_Click(object sender, EventArgs e)
        {
            ...
            Literal lblName = (Literal)item.FindControl("litName"); // Fix name retrieval
            ...
            if (hfProductId != null && lblPrice != null && lblName != null)
            {
                ...
                string productType = "Bracelet"; // Product Type for Cart
                int quantity = 1;
