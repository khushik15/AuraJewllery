...
namespace Jewllery
{
    public partial class pendant : System.Web.UI.Page
    {
        ...
        private void LoadPendants()
        {
            ...
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(query, conn))
                {
                    ...
                    da.Fill(dt);
                    rptPendants.DataSource = dt;
                    rptPendants.DataBind();
                }
            }
        }
        ...
        protected void btnAddToCart_Click(object sender, EventArgs e)
        {
            ...
            // Ensure the controls exist before accessing them
            ...
            if (hfProductId != null && lblPrice != null && lblName != null)
            {
                ...
                string productType = "Pendant"; // This is specific to this page
                int quantity = 1;
