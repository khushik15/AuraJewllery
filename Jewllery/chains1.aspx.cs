...
namespace Jewllery
{
    public partial class chains1 : System.Web.UI.Page
    {
        ...
        private void LoadChains()
        {
            ...
            {
                string query = "SELECT ID, Name, Color, Price, ImageUrl FROM Chains1";
        ...
        protected void btnAddToCart_Click(object sender, EventArgs e)
        {
            ...
            if (hfProductId != null && lblPrice != null && lblName != null)
            {
                ...
                string productType = "Chain"; // This is specific to this page
                int quantity = 1;
